  ...
  const reviewsWithImage = reviews.map((item) => {
    ...
    return {
      ...
      image: item?.customerId?.profileImage
        ? `https://marketplaceaws.waayupro.in/uploads/images/customer/${item?.customerId?.profileImage}`
        : "https://marketplaceaws.waayupro.in/uploads/images/review/profile.png",
